![Provider](https://img.shields.io/badge/Provider-Google-1a73e8)
![Certificate](https://img.shields.io/badge/Certificate-Cybersecurity-1a73e8)
...
I started by building a working vocabulary of the field. These are the terms I now use to reason about risk:
...
I also learned *why* these attacks succeed — they lean on predictable human responses: **authority** (respecting a perceived figure of power), **intimidation** (bullying a target into compliance), **consensus** (implying "everyone else already agreed"), **scarcity** (implying limited availability), **familiarity** (faking a personal connection), **trust** (building a relationship to exploit later), and **urgency** (rushing a decision before it can be questioned).

### 4. CISSP Security Domains and Attack Types

The eight CISSP domains gave me a way to organize a security analyst's responsibilities and map each attack type to the area of the business it threatens most:
...
I learned that **security ethics** — the guidelines for making appropriate decisions as a professional — govern how far a defender can go when responding to an attack.
