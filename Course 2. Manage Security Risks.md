![Course](https://img.shields.io/badge/Course%202-Manage%20Secuirty%20Risks-4285F4)
...
<p align="center">
  <img src="#" alt="Certificate placeholder" width="480"/>
</p>
...
### NIST CSF and its functions

NIST CSF, which stands for the National Institute of Standards and Technology Cybersecurity Framework. Think of it like a superhero team for cybersecurity, with five amazing members, or "functions," that work together to keep organizations safe from online threats!

Imagine your home is a treasure chest, and you want to protect your valuable belongings inside. The NIST CSF functions are like the steps you'd take to keep your treasures safe:

Identify: First, you need to know what treasures you have and where they are. This is like knowing all the important systems and data in an organization.
Protect: Next, you'd put locks on your doors and windows, maybe even get a guard dog! This is like implementing security policies, training employees, and using tools to prevent attacks.
Detect: Even with locks, you need to know if someone is trying to break in. This is like having an alarm system that alerts you to suspicious activity.
Respond: If the alarm goes off, you need a plan to deal with the intruder. This is like having a team ready to contain, analyze, and fix security incidents.
Recover: After an incident, you need to get everything back to normal. This is like repairing any damage and making sure your home is secure again.
Just like these steps keep your home safe, the NIST CSF functions help organizations manage cybersecurity risks, learn from mistakes, and quickly recover from any incidents. It's all about being prepared and having a solid plan!

### OSWAP Top 10

you learned that cybersecurity analysts help keep data safe and reduce risk for an organization by using a variety of security frameworks, controls, and security principles. In this reading, you will learn about more Open Web Application Security Project, recently renamed Open Worldwide Application Security Project® (OWASP), security principles and how entry-level analysts use them. 
